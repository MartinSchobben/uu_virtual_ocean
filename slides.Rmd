...
**What I have done so far:**
 ...
 - Off/online course in data analysis with R
...
One of the biggest problems in research is the inadvertent destruction of data and the inaccessibility of data due to poor labeling and description of data. 

**Solutions:**

- Pure R client for iRODS (official launch June this year)
- Opinionated and interactive tools for dealing with data management including data annotation, standards, and versioning.
- Workflows and processing pipelines with integrated data management functionality
